...
public class HighScoreNumTurns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Activity Lifecycle", "onCreate - HighScoreNumTurns");
        setContentView(R.layout.activity_high_score_num_turns);

        ArrayList<String> playerScores = new ArrayList<String>();
        String receiveString ="";
        try {
            InputStream inputStream = getApplicationContext().openFileInput("HighScoreNumTurns.txt");
            ...
            try {
                ...
                for (int i = 0; i  < playerScores.size()-1; i++)
                {
                    if(i == 0)
                    {
                        ...
                        textView.setText(String.format(res.getString(R.string.highscore_num_turns))+"\n");
    ...
    protected void onPause() {
        super.onPause();
        Log.i("Activity Lifecycle", "onPause - HighScoreNumTurns");
    }
    @Override
    protected void onStart() {
        super.onStart();
        Log.i("Activity Lifecycle", "onStart - HighScoreNumTurns");
    }
    @Override
    protected void onStop() {
        super.onStop();
        Log.i("Activity Lifecycle", "onStop - HighScoreNumTurns");
    }
    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("Activity Lifecycle", "onDestroy - HighScoreNumTurns");
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Log.i("Activity Lifecycle", "onRestart - HighScoreNumTurns");
    }

    protected void onResume() {
        super.onResume();
        Log.i("Activity Lifecycle", "onResume - HighScoreNumTurns");
    }
